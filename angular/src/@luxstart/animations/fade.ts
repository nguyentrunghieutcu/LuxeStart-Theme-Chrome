...
const fadeInOut = trigger('fadeInOut',
    [
        ...
        transition('void => *', [
            ...
            {
                params: {
                    timings: `${FuseAnimationDurations.exiting} ${FuseAnimationCurves.deceleration}`
                }
            }),
...
export { fadeIn, fadeInTop, fadeInOut, fadeInBottom, fadeInLeft, fadeInRight, fadeOut, fadeOutTop, fadeOutBottom, fadeOutLeft, fadeOutRight };
